#!/usr/bin/env python
# This file is part sale_payment_type module for Tryton.
...
name = 'trytonspain_sale_payment_type'
download_url = 'https://bitbucket.org/trytonspain/trytond-sale_payment_type'
...
setup(name=name,
    version=version,
    description='Tryton Sale Payment Type Module',
